...
<head>
    ...
    <title>{{ $title ?? 'Beranda' }} - Ponpes Mathali\'ul Anwar</title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-20">
                <div class="flex items-center">
                    <span class="text-2xl font-bold text-pesantren-dark">Mathali'ul Anwar</span>
                </div>
                <div class="hidden md:flex space-x-8 items-center">
                    <a href="/" class="hover:text-pesantren-primary font-medium transition">Home</a>
                    <a href="#" class="hover:text-pesantren-primary font-medium transition">Profil</a>
