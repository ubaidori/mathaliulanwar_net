<div class="max-w-6xl mx-auto py-8 px-4 sm:px-6">
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-2xl font-bold text-zinc-900 dark:text-white tracking-tight">Tulis Berita</h1>
            <p class="mt-1 text-sm text-zinc-500 dark:text-zinc-400">Buat artikel berita atau pengumuman mading baru.</p>
        </div>
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <x-card class="p-6 space-y-6 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800">
                    ...
                    <div class="space-y-1">
                        ...
                        <input wire:model="title" type="text" placeholder="Masukkan judul menarik..."
                ...
                <div class="hidden lg:flex justify-end">
                    <button type="submit" class="inline-flex items-center justify-center px-8 py-3 bg-zinc-900 dark:bg-white text-white dark:text-zinc-900 font-bold text-sm rounded-lg hover:bg-zinc-800 dark:hover:bg-zinc-200 transition shadow-lg transform active:scale-95">
                        <span wire:loading.remove>Terbitkan Berita</span>
            ...
            <div class="lg:col-span-1 space-y-6">
                ...
                <x-card class="p-6 space-y-5 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800">
                    ...
                    <div class="space-y-1">
                        ...
                        <div class="relative">
                            ...
                            <input wire:model="writer" type="text" placeholder="Redaksi"
                ...
                <x-card class="p-6 space-y-4 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800">
                    ...
                    <div class="relative group">
                        ...
                        <div class="border-2 border-dashed border-zinc-300 dark:border-zinc-700 rounded-xl p-6 text-center group-hover:bg-zinc-50 dark:group-hover:bg-zinc-800 transition-colors flex flex-col items-center justify-center min-h-[150px]">
                            @if ($image)
                                <img src="{{ $image->temporaryUrl() }}" class="w-full rounded-lg shadow-sm object-cover max-h-48">
                                <p class="text-xs text-zinc-500 mt-2">Klik untuk mengganti</p>
                            @else
                                ...
                                <span class="text-sm font-medium text-zinc-900 dark:text-white">Upload Cover</span>
                                <span class="text-xs text-zinc-500 dark:text-zinc-400 mt-1">Maks. 2MB</span>
                            @endif
                        </div>
                    </div>
